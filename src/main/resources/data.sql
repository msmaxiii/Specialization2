...
('Kourtney', 'Pace123', 'pace@gmail'),
('Lee', 'Lind456', 'Lee@gmail')
;

insert into Book (genre,book1,book2,book3,book4,book5) values
...
('Biography','AND THERE WAS LIGHT','Faith STILL MOVES MOUNTAINS','Waxing On THE KARATE KID AND ME','Bitter-sweet','THE LIGHT WE CARRY')
('Mystery','THE ATLAS PARADOX','The Bullet That MISSED','THE MAID','RUN ROSE RUN','A WORLD OF CURIOSITIES'),
;
